...
import util.android.textviews.VerticalTextView;

/**
 * <p>A VerticalTextView extension to {@link AppCompatFontTextView}</p>
 *
 * @author Jeff Sutton
 * @since 1.2.7
 */
public class AppCompatFontVerticalTextView extends AppCompatFontTextView {

    private static final String LOGTAG = VerticalTextView.class.getSimpleName();

    private final boolean topDown;

    public AppCompatFontVerticalTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
